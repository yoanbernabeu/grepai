...
export const navigation: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'grepai refs', href: '/grepai/commands/grepai_refs/', order: 9 },
      { label: 'grepai refs readers', href: '/grepai/commands/grepai_refs_readers/', order: 10 },
      { label: 'grepai refs writers', href: '/grepai/commands/grepai_refs_writers/', order: 11 },
      { label: 'grepai refs graph', href: '/grepai/commands/grepai_refs_graph/', order: 12 },
      { label: 'grepai rpg', href: '/grepai/commands/grepai_rpg/', order: 13 },
      { label: 'grepai rpg search', href: '/grepai/commands/grepai_rpg_search/', order: 14 },
      { label: 'grepai rpg fetch', href: '/grepai/commands/grepai_rpg_fetch/', order: 15 },
      { label: 'grepai rpg explore', href: '/grepai/commands/grepai_rpg_explore/', order: 16 },
      { label: 'grepai agent-setup', href: '/grepai/commands/grepai_agent-setup/', order: 17 },
      { label: 'grepai mcp-serve', href: '/grepai/commands/grepai_mcp-serve/', order: 18 },
      { label: 'grepai status', href: '/grepai/commands/grepai_status/', order: 19 },
      { label: 'grepai update', href: '/grepai/commands/grepai_update/', order: 20 },
      { label: 'grepai version', href: '/grepai/commands/grepai_version/', order: 21 },
      { label: 'grepai workspace', href: '/grepai/commands/grepai_workspace/', order: 22 },
      { label: 'grepai workspace list', href: '/grepai/commands/grepai_workspace_list/', order: 23 },
      { label: 'grepai workspace show', href: '/grepai/commands/grepai_workspace_show/', order: 24 },
      { label: 'grepai workspace status', href: '/grepai/commands/grepai_workspace_status/', order: 25 },
      { label: 'grepai workspace create', href: '/grepai/commands/grepai_workspace_create/', order: 26 },
      { label: 'grepai workspace add', href: '/grepai/commands/grepai_workspace_add/', order: 27 },
      { label: 'grepai workspace remove', href: '/grepai/commands/grepai_workspace_remove/', order: 28 },
      { label: 'grepai workspace delete', href: '/grepai/commands/grepai_workspace_delete/', order: 29 },
    ],
  },
  {
    title: 'Backends',
